...
export const faqs: FAQItem[] = [
  ...
  {
    title: "Where do you see your career in 2-3 years?",
    description:
      "I would love to work as software engineer with great minds and learn how to develop software at scale. Additionally, I would like to actively contribute to team projects, possibly taking on leadership roles in smaller initiatives to build my project management and team collaboration abilities.",
  },
  {
  ...
  {
    title: "Do you prefer working remotely or in an office?",
    description:
